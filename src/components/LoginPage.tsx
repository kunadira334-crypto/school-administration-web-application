    ...
    >
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 md:p-10">
        <div className="flex justify-center mb-4">
          <div className="h-16 w-16 rounded-full bg-teal-700 flex items-center justify-center text-white text-2xl font-bold">
            MI
          </div>
        </div>
        <h1 className="text-lg font-bold text-center text-teal-800">
          SIM {settings.namaMadrasah || 'MI Mambaul Ulum Sumberduren'}
        </h1>
        <p className="text-center text-xs text-gray-500 mt-1 mb-6">
          Yayasan Mambaul Ulum — Sistem Administrasi Sekolah
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-teal-700 hover:bg-teal-800 text-white font-semibold rounded-lg py-2.5 text-sm transition"
          >
            Masuk
          </button>
        </form>
        ...
        <div className="mt-6 border-t pt-4">
          <p className="text-xs text-gray-400 text-center mb-2">Akun demo (klik untuk isi otomatis):</p>
          <div className="flex flex-wrap gap-2 justify-center">
            ...
            <button
              onClick={() => quickFill('wali1', 'wali123')}
              className="text-xs bg-teal-50 text-teal-700 px-3 py-1 rounded-full hover:bg-teal-100"
            >
              Wali Kelas 1
            </button>
            <button
              onClick={() => quickFill('wali6a', 'wali123')}
              className="text-xs bg-teal-50 text-teal-700 px-3 py-1 rounded-full hover:bg-teal-100"
            >
              Wali Kelas 6A
            </button>
